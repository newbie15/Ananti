$(document).ready(function () {
    ...
    data_default = [
        ...
        ["k) rute shield koneksinya tidak melewati window/loop (seperti pada lubang CT)","",""],
        ["l) Terdapat tape (code) pada tiap phase","",""],
        ["m) Kondisi jaket dan kondisi insulasi  keadaan baik (lakukan jika memungkinkan)","",""],
        ["n) Terdapat kontaminasi, debu, perubahan warna pada Stress Cone dan Insulator Pin","",""],
        ["o) Tidak ada kerusakan pada stress cone dan Bushing Boot/pelindung","",""],
    ...
    $("#simpan").click(function () {
        ...
        $.ajax({
            method: "POST",
            url: SITE_URL+"job_aid/j60/a0a1_save",
            success: sukses,
            data: {
                pabrik: $("#pabrik").val(),
    ...
    function ajax_refresh() {
        $.ajax({
            method: "POST",
            url: SITE_URL + "job_aid/j60/a0a1_load",
            data: {
