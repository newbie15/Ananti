$(document).ready(function () {
    ...
    data_default = [
        ...
        ["Pengukuran Alternator Line R-Ground","",""],
        ...
        ["Polarisasi Index (PI 2) *IR10/IR1","",""],
        ["DAR *IR1/IR0.5","",""],
        ["Pengukuran Alternator Line T-Ground","",""],
        ["Insulation Resistance Menit 0.5","",""],
        ["Insulation Resistance Menit 1","",""],
        ["Insulation Resistance Menit 2","",""],
        ["Insulation Resistance Menit 3","",""],
        ...
        if (data.length<1) {
            ...
            $('#my-spreadsheet').jexcel('setStyle', 
                [
                    ...
                    { A42: 'text-align:left;' },
                    { A43: 'text-align:left;' },
                    { A44: 'text-align:left;font-weight: bold;background-color: yellow' },
                    { B44: 'text-align:left;font-weight: bold;background-color: yellow' },
                    { C44: 'text-align:left;font-weight: bold;background-color: yellow' },
                    { A45: 'text-align:left;' },
                    { A46: 'text-align:left;' },
                    { A47: 'text-align:left;' },
                    { A48: 'text-align:left;' },
                    ...
                    { A56: 'text-align:left;' },
                    { A57: 'text-align:left;' },
                    { A58: 'text-align:left;font-weight: bold;background-color: yellow' },
                    { B58: 'text-align:left;font-weight: bold;background-color: yellow' },
                    { C58: 'text-align:left;font-weight: bold;background-color: yellow' },
                    { A59: 'text-align:left;' },
                    { A60: 'text-align:left;' },
                    { A61: 'text-align:left;' },
                    { A62: 'text-align:left;' },
                    ...
                    { A70: 'text-align:left;' },
                    { A71: 'text-align:left;' },
                    { A72: 'font-weight: bold;background-color: yellow' },
                    { B72: 'font-weight: bold;background-color: yellow' },
                    { C72: 'font-weight: bold;background-color: yellow' },
                    { A73: 'text-align:left;' },
                    { A73: 'text-align:left;' },
                    { A74: 'text-align:left;' },
    ...
    $("#simpan").click(function () {
        ...
        $.ajax({
            method: "POST",
            url: SITE_URL+"job_aid/j51/a8_save",
            success: sukses,
            data: {
                pabrik: $("#pabrik").val(),
    ...
    function ajax_refresh() {
        $.ajax({
            method: "POST",
            url: SITE_URL + "job_aid/j51/a8_load",
            data: {
