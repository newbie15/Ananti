$(document).ready(function () {
    ...
    function refresh_modal() {
        $.ajax({
            method: "POST",
            url: SITE_URL + "attachment/list_attachment_modal/" + $("#pabrik").val() +"/J61",
            data: {
            ...
            // console.log(y);
            var table = $('#dt-table-j61').DataTable({
                destroy: true,
                data: y,
                columns: [{
                    title: "Daftar"
    ...
    $("#simpan").click(function () {
        ...
        $.ajax({
            method: "POST",
            url: SITE_URL+"job_aid/j61/a9_save",
            success: sukses,
            data: {
                pabrik: $("#pabrik").val(),
                // station: $("#station").val(),
    ...
    function ajax_refresh() {
        $.ajax({
            method: "POST",
            url: SITE_URL + "job_aid/j61/a9_load",
            data: {
                id_pabrik: $("#pabrik").val(),
