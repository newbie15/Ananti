$(document).ready(function () {
    ...
    data_default = [
        ...
        ["b) Personel sudah memakai PPE yang sesuai untuk perlindungan listrik kejut dan arc flash","-",""],
    ...
    $("#simpan").click(function () {
        ...
        $.ajax({
            method: "POST",
            url: SITE_URL+"job_aid/j51/a3_save",
            success: sukses,
            data: {
                pabrik: $("#pabrik").val(),
    ...
    function ajax_refresh() {
        $.ajax({
            method: "POST",
            url: SITE_URL + "job_aid/j51/a3_load",
            data: {
