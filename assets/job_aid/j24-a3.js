$(document).ready(function () {
    ...
    data_default = [
        ...
        ["Temperature VFD","",""],        
        ["Suhu Maksimal pada Casing/Frame VFD","C",""],
        ["Suhu Maksimal pada Kipas Pendingin","C",""],
        ["Suhu Maksimal pada koneksi kabel VFD (input/output)","C",""],
        ["Suhu Maksimal pada terminal strip/blok VFD","C",""],
        ["Suhu Maksimal pada Filter VFD","C",""],
        ["Suhu Maksimal pada Kontaktor VFD","C",""],
    ];
        ...
        if (data.length<1) {
            ...
            $('#my-spreadsheet').jexcel('setStyle', 
                [
                    ...
                    { A16: 'text-align:left;' },
                    { A17: 'text-align:left;' },
                    { A18: 'text-align:left;font-weight: bold;background-color: yellow' },
                    { B18: 'text-align:left;font-weight: bold;background-color: yellow' },
                    { C18: 'text-align:left;font-weight: bold;background-color: yellow' },
                    { A19: 'text-align:left;' },
                    { A20: 'text-align:left;' },
                    { A21: 'text-align:left;' },
                    { A22: 'text-align:left;' },
    ...
    $("#simpan").click(function () {
        ...
        $.ajax({
            method: "POST",
            url: SITE_URL+"job_aid/j24/a3_save",
            success: sukses,
            data: {
                pabrik: $("#pabrik").val(),
    ...
    function ajax_refresh() {
        $.ajax({
            method: "POST",
            url: SITE_URL + "job_aid/j24/a3_load",
            data: {
