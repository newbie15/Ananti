...
class Jobaid extends CI_Controller {
	...
	public function index()
	{
		...
		$output['content'] = "test";
		$output['main_title'] = "Data Job Aid";
		...
		$this->load->view('content-job-aid',$output);
		$this->load->view('footer',$footer);
	}

	public function load()
	{
		$query = $this->db->query("SELECT nama,kapasitas,area FROM aux_job_aid;");
