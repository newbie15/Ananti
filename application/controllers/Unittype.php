...
class Unittype extends CI_Controller {
	...
	public function index()
	{
		...
		$output['content'] = "test";
		$output['main_title'] = "Data Unit Type";
	...
	{
		$query = $this->db->query("SELECT `nama`,`type` FROM aux_unit_type;");
