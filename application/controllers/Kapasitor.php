...
class Kapasitor extends CI_Controller {
	...
	public function load()
	{
		...
		$query = $this->db->query("SELECT kapasitor,kvar,jan,feb,mar,apr,mei,jun,jul,agt,sep,okt,nov,des,keterangan FROM m_kapasitor where id_pabrik = '$id_pabrik' AND tahun = '$tahun';");
