...
class J1 extends CI_Controller {
	...
	{
		$query = $this->db->query("SELECT nama,comment FROM aux_job_aid WHERE nomor = 'J1';");
		foreach ($query->result() as $row)
		{
			$output['comment'] = $row->comment;
			$header['title'] = "J1 - ".$row->nama;
		}

		$output['content'] = "test";
		$output['main_title'] = "Data Avaibility Cricital Machine";
		
		// $header['title'] = "J1 - RCD GFCI Testing";
		$header['css_files'] = [
		...
		$query = $this->db->query("SELECT comment FROM aux_job_aid WHERE nomor = 'J1';");
		foreach ($query->result() as $row)
		{
			$output['comment'] = $row->comment;
		}
		...
		$this->load->view('job_aid/content-j1',$output);
	...
	public function a0()
	{
		...
		$header['title'] = "J1 A0 Visual Inspection";
		$header['css_files'] = [
			base_url("assets/jexcel/css/jquery.jexcel.css"),
			base_url("assets/jexcel/css/jquery.jcalendar.css"),
	...
	public function a0_save(){
		...
		$this->db->query("DELETE FROM `job_aid_j1_a0` where id_pabrik = '$pabrik' AND tanggal = '$tanggal' ");
		...
		print_r($datax);
		$this->db->insert_batch('job_aid_j1_a0', $datax);
	}
	...
	public function a0_load(){
		...
		$query = $this->db->query("SELECT * FROM job_aid_j1_a0
	...
	public function a14()
	{
		...
		$header['title'] = "J1 A14 Electrical Operability Test";
		$header['css_files'] = [
			base_url("assets/jexcel/css/jquery.jexcel.css"),
			base_url("assets/jexcel/css/jquery.jcalendar.css"),
			base_url("assets/datatables/css/jquery.dataTables.min.css"),
	...
	public function a15()
	{
		...
		$header['title'] = "J1 A15 Mechanical Operability Test";
		$header['css_files'] = [
			base_url("assets/jexcel/css/jquery.jexcel.css"),
			base_url("assets/jexcel/css/jquery.jcalendar.css"),
			base_url("assets/datatables/css/jquery.dataTables.min.css"),
