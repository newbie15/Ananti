...
class J14 extends CI_Controller {
	...
	{
		$query = $this->db->query("SELECT nama,comment FROM aux_job_aid WHERE nomor = 'J14';");
		foreach ($query->result() as $row)
		{
			$output['comment'] = $row->comment;
			$header['title'] = "J14 - ".$row->nama;
		}
		...
		$footer['js_files'] = [
			...
			base_url("assets/job_aid/j14.js"),
		];
		...
		$this->load->view('job_aid/content-j14',$output);
	...
	public function a0()
	{
		...
		$footer['js_files'] = [
			...
			base_url("assets/mdp/config.js"),
			base_url("assets/mdp/global.js"),
			base_url("assets/job_aid/j14-a0.js"),
		];
		...
		$this->load->view('header',$header);
		$this->load->view('job_aid/content-j14-a0',$output);
		$this->load->view('footer',$footer);		
	}
	...
	public function a14()
	{
		...
		$footer['js_files'] = [
			...
			base_url("assets/mdp/config.js"),
			base_url("assets/mdp/global.js"),
			base_url("assets/job_aid/j14-a14.js"),
		];
		...
		$this->load->view('header',$header);
		$this->load->view('job_aid/content-j14-a14',$output);
		$this->load->view('footer',$footer);		
	}
	...
	public function a15()
	{
		...
		$footer['js_files'] = [
			...
			base_url("assets/mdp/config.js"),
			base_url("assets/mdp/global.js"),
			base_url("assets/job_aid/j14-a15.js"),
		];
		...
		$this->load->view('header',$header);
		$this->load->view('job_aid/content-j14-a15',$output);
		$this->load->view('footer',$footer);		
	}	
