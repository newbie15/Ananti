...
class J3 extends CI_Controller {
	...
	public function index()
	{
		...
		$query = $this->db->query("SELECT nama,comment FROM aux_job_aid WHERE nomor = 'J3';");
		foreach ($query->result() as $row)
		{
			$output['comment'] = $row->comment;
			$header['title'] = "J3 - ".$row->nama;
		}
		...
		$query = $this->db->query("SELECT comment FROM aux_job_aid WHERE nomor = 'J3';");
		foreach ($query->result() as $row)
		{
			$output['comment'] = $row->comment;
		}
		...
		$this->load->view('job_aid/content-j3',$output);
	...
	public function a0()
	{
		...
		$this->load->view('header',$header);
		$this->load->view('job_aid/content-j3-a0',$output);
		$this->load->view('footer',$footer);		
	}
