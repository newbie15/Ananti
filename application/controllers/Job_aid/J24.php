...
class J24 extends CI_Controller {
	...
	public function a14()
	{
		...
		$footer['js_files'] = [
			...
			base_url("assets/mdp/config.js"),
			base_url("assets/mdp/global.js"),
			base_url("assets/job_aid/j24-a14.js"),
		];
		...
		$this->load->view('header',$header);
		$this->load->view('job_aid/content-j24-a14',$output);
		$this->load->view('footer',$footer);		
	}
	...
	public function a15()
	{
		...
		$footer['js_files'] = [
			...
			base_url("assets/mdp/config.js"),
			base_url("assets/mdp/global.js"),
			base_url("assets/job_aid/j24-a15.js"),
		];
		...
		$this->load->view('header',$header);
		$this->load->view('job_aid/content-j24-a15',$output);
		$this->load->view('footer',$footer);		
	}	
