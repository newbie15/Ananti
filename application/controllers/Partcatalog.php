...
class Partcatalog extends CI_Controller {
	...
	public function index()
	{
		...
		$output['content'] = "test";
		$output['main_title'] = "Data Katalog Part ( For All Mill )";
		...
		$footer['js_files'] = [
			...
			base_url("assets/mdp/partcatalog.js"),
		];
		...
		$crud->set_table('master_part_catalog'); 
		$output['crud'] = $crud->render();
		$header['crud'] = $output['crud']->css_files; 
		$footer['crud'] = $output['crud']->js_files; 

		$this->load->view('header',$header);
		$this->load->view('content-part-catalog',$output);
		$this->load->view('footer',$footer);

		// $this->load->view('example',$output['crud']);
