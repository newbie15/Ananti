...
<?php } if($this->session->tipe == "wsc" || $this->session->kategori < 2) { ?>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu" style="display: none;">
            ...
            <li><a href="<?php echo base_url("projectplan"); ?>"><i class="fa fa-calendar"></i>Plan Project<span class="pull-right-container"><small class="label pull-right bg-red">Harian</small></span> </a></li>
