    ...
    <section class="content-header">
        <h1>
            <ul class="nav nav-tabs">
                <li class="active"><a href="<?php echo base_url("sop") ?>" aria-expanded="true">SOP</a></li>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?= base_url("sop/upload") ?>" class="dropzone needsclick dz-clickable" id="dropzones">
