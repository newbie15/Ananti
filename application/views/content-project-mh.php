...
<div class="content-wrapper">
    ...
    <h1>
        ...
        <li class=""><a href="<?php echo base_url("project")?>" aria-expanded="true">Project</a></li>
        <li class="active"><a href="<?php echo base_url("project/mh")?>" aria-expanded="true">Project MH</a></li>
