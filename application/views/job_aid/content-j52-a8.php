    ...
    <section class="content-header">
      <h1>
        <ul class="nav nav-tabs">
          ...
          <li class="active"><a href="<?php echo site_url("job_aid/j52/a8") ?>" aria-expanded="false">A8 - Insulation Resistance Testing</a></li>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?= site_url("job_aid/j52/a8_upload") ?>" class="dropzone needsclick dz-clickable" id="dropzones">
