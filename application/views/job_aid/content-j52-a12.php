  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <ul class="nav nav-tabs">
          ...
          <li class=""><a href="<?php echo site_url("job_aid/j52/a0") ?>" aria-expanded="false">A0 - Visual Inspection</a></li>
          <li class=""><a href="<?php echo site_url("job_aid/j52/a8") ?>" aria-expanded="false">A8 - Insulation Resistance Testing</a></li>
          <li class="active"><a href="<?php echo site_url("job_aid/j52/a12") ?>" aria-expanded="false">A12 - Winding Resistance Testing</a></li>
    ...
    <section class="content">
      ...
      <div class="modal fade in" id="modal-j52" style="display: none;">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">×</span></button>
              <h4 class="modal-title">Daftar Attachment dengan Job Aid J52</h4>
            </div>
      ...
      <div class="modal fade in" id="modal-upload" style="display: none;">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?= site_url("job_aid/j52/a12_upload") ?>" class="dropzone needsclick dz-clickable" id="dropzones">
