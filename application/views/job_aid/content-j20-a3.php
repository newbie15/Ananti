    ...
    <section class="content-header">
      <h1>
        <ul class="nav nav-tabs">
          ...
          <li class="active"><a href="<?php echo site_url("job_aid/j20/a3") ?>" aria-expanded="false">A3 - Infrared Inspection</a></li>
          <li class=""><a href="<?php echo site_url("job_aid/j20/a14") ?>" aria-expanded="false">A14 - Electrical Operability Test</a></li>
        </ul>
      </h1>
      <ol class="breadcrumb">
