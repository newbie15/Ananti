    ...
    <section class="content-header">
        <h1>
            <ul class="nav nav-tabs">
                ...
                <li class=""><a href="<?php echo site_url("ik") ?>" aria-expanded="false">Instruksi Kerja</a></li>
                <li class=""><a href="<?php echo site_url("drawing") ?>" aria-expanded="false">Drawing</a></li>
                <li class="active"><a href="<?php echo site_url("datasheet") ?>" aria-expanded="false">Datasheet</a></li>
            </ul>
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?= site_url("datasheet/upload") ?>" class="dropzone needsclick dz-clickable" id="dropzones">
